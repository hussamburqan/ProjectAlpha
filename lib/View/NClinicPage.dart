            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                ...
                child: Padding(
                  ...
                  child: Card(color: Color(-789517),elevation: 6,
                    ...
                    child: Row(
                      ...
                      children: [
                                      ...
                                      child: Padding(
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            SizedBox(width: 5,),
                                            SvgPicture.asset('assets/city.svg',height: screenSize.height *0.015,),
                                          ],
                                        ),
                                        ...
                                        child: Padding(
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(width: 5,),
                                              SvgPicture.asset('assets/type.svg',height: screenSize.height *0.014,),
                                            ],
                                          ),
                        ...
                        if (clinic.photo != null)
                          Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: MyImageNet(path: '${AppConstants.baseURLPhoto}storage/${clinic.photo}',sizeh: screenSize.height,)
                          )
                        else
